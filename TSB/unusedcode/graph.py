...
# This file creates a graph of navigatable coordinates from a certain given matrix from a map
...
# If you have the time, try to do this automatically
map = [
    [
        (0, 0, 0),
        (0, 1, 0),
...
# put the numeber of lines that exist on the map
lines = 51
# put the number collumns that exist in the map
coordinates = 46
